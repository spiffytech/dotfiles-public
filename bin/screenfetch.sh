...
display=( host distro kernel uptime shell )
...
"${c1}                            ee         ee"
"${c1}                           eee       eee"
"${c2}            wwwwwwwwww    "${c1}"eeee     eeee"
"${c2}        wwwwwwwwwwwwwwww"${c1}"eeeeeeeeeeeeeee"
"${c2}     wwwwwwwwwwwwwwwwwwwwww"${c1}"eeeeeeeeeee            %s"
"${c2}   wwwww            "${c1}"eee"${c2}"wwwwwwww"${c1}"eeeeeeee          %s"
"${c2}  wwwww             "${c1}"eeee"${c2}"wwwwwwwww"${c1}"eeeeeeeeee      %s"
"${c2} wwww               "${c1}"eeeeee"${c2}"wwwwwwwww"${c1}"eeeeeeeeeeee  %s"
"${c2} ww                  "${c1}"eeeeeee"${c2}"wwwwwwwww"${c1}"ee          %s"
"${c2} w                     "${c1}"eeeeee"${c2}"wwwwwwwwww          %s"
"${c2}                          "${c1}"eeeee"${c2}"wwwwwwww          %s"
"${c2}                                wwwwwww          %s"
"${c2}                                 wwwwww          %s"
"${c2}                                 wwwwww          %s"
"${c2}                                 wwwww           %s"
